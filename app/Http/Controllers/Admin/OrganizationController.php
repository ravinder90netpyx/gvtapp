...
use App\Models\Organization as DefaultModel;
...
class OrganizationController extends Controller{
    public $module = array(
        'module_view' => 'organization',
        'module_route' => 'organization',
        'permission_group' => 'organization',
        'main_heading' => 'Organization',
    ...
    public function index(Request $request, DefaultModel $model){
        ...
        $model_get = $model->latest()->where('delstatus', '<', '1');
