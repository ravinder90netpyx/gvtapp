...
use App\Models\Expense_Type as DefaultModel;
...
class ExpenseTypeController extends Controller{
    public $module = array(
        'module_view' => 'expense_type',
        'module_route' => 'expense_type',
        'permission_group' => 'expense_type',
        'main_heading' => 'Expense Type',
        'default_perpage' => 10
    );
